...
const GameList = ( { items, itemsPerPage } ) => {
    ...
    return (
        <>
            ...
            <div className={`cards mt-[54px] grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 md:grid-rows-2 gap-[8px] md:gap-[32px] 2xl:mx-[256px] transition-all duration-[300ms] ease-in ${getAnimationClass(phase, direction)}`}>
                {
