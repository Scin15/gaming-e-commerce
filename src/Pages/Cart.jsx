    ...
    return (
        <>
            ...
            <div className="py-[168px] max-w-[512px] md:m-auto mx-[10px] flex flex-col gap-[32px]">
                ...
                <button onClick={handleDialog} className="rounded-full xl:px[32px] px-[16px] py-[8px] xl:py-[16px] text-p bg-primary hover:shadow-xl active:bg-primary/50 xl:mt-0 mt-[32px] xl:w-[258px] w-[230px] m-auto">Avanti
                </button>
            </div>
        </>
    )
